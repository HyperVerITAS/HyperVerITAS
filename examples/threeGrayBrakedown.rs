...
fn run_three_gray_brake(testSize: usize) {
    ...
    for iii in 0..1 {
        ...
        let mut RGBEvals = [toFieldVec::<F>(&origImg.R),toFieldVec::<F>(&origImg.G),toFieldVec::<F>(&origImg.B)];
        let mut RGBEvalsFri =
        ...
        for i in 0..3{
            ...
            evals.push(Evaluation::new(
                ...
                polynomials[i].evaluate(&points[2]),
            ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[3].evaluate(&points[0]),
        ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[3].evaluate(&points[3]),
        ));
        // // //----------------------------------------------GRAYSCALE:We now add alpha_range for h----------------------------------------------
        evals.push(Evaluation::new(
            4, //This is the poly index
            3, //This is the point index
            polynomials[4].evaluate(&points[3]),
        ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[4].evaluate(&points[4]),
        ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[4].evaluate(&points[5]),
        ));
        
        // // //----------------------------------------------GRAYSCALE:We then add prod for 1...10----------------------------------------------
        evals.push(Evaluation::new(
            5, //This is the poly index
            1, //This is the point index
            polynomials[5].evaluate(&points[1]),
        ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[5].evaluate(&points[6]),
        ));

        // // //----------------------------------------------GRAYSCALE:We now add alpha_range for frac----------------------------------------------

        evals.push(Evaluation::new(
            6, //This is the poly index
            6, //This is the point index
            polynomials[6].evaluate(&points[6]),
        ));
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[5].evaluate(&points[7]),
        ));
        ...
        evals.push(Evaluation::new(
            6, //This is the poly index
            7, //This is the point index
            polynomials[6].evaluate(&points[7]),
        ));            
        ...
        evals.push(Evaluation::new(
            ...
            polynomials[5].evaluate(&points[8]),
        ));
        ...
        evals.push(Evaluation::new(
            6, //This is the poly index
            8, //This is the point index
            polynomials[6].evaluate(&points[8]),
        ));
        ...
        evals.push(Evaluation::new(
            3, //This is the poly index
            2, //This is the point index
            polynomials[3].evaluate(&points[2]),
        ));
...
fn main(){
    ...
    for i in first_size..last_size+1 {
        println!("3 Channel Grayscale, HyperVerITAS Brakedown. Size: 2^{:?}\n", i);
        let _res = run_three_gray_brake(i);
        println!("-----------------------------------------------------------------------");
    }
}