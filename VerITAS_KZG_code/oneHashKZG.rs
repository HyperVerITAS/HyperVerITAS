...
fn eval_polynomials(domain: GeneralEvaluationDomain::<Fr>, start: u128, instance_hash: &str, time_ck: &CommitterKey::<Bls12_381>,  postfix: &str, mySize: &usize, D: &usize)  
-> (Vec<Commitment<Bls12_381>>, Vec<Commitment<Bls12_381>>, Vec<Commitment<Bls12_381>>, Vec<Vec<Fr>>, Vec<Vec<Fr>>, Vec<Vec<Fr>>, Vec<Fr>, EvaluationProof<Bls12_381>, EvaluationProof<Bls12_381>, EvaluationProof<Bls12_381>)  {
    ...
    let file = read_photo("Veri", postfix, mySize);
    for line in file.lines() {
        let line = line.expect("Unable to read line");
        let i = line.parse::<i32>().unwrap();
...
fn run_one_hash(mySize: usize, D: usize) {
    // ===================================================================================================================================
    ...
    let filename = get_filename("Veri", "R", &mySize);
...
// ===================================================================================================================================
    ...
    let (coms0, coms1, coms2, evals0, evals1, evals2, prover_hash_coeffs, proof0, proof1, proof2) = eval_polynomials(domain, start, instance_hash.clone(), &time_ck, "R", &mySize, &D);
    ...
    println!("Total TAKES {:?} seconds", elapsed_time.as_millis() as f64 / 1000 as f64);
// ===================================================================================================================================
